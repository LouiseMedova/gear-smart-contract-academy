...
import { DebugData, DispatchMessageEnqueuedData, InitFailureData, InitMessageEnqueuedData, InitSuccessData, LogData, ProgramData, TransferData, MessageDispatchedData } from './EventData';
...
export declare class MessageDispatchedEvent extends GearEvent {
    get data(): MessageDispatchedData;
}
